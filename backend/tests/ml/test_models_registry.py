...
from backend.ml.models.registry import ModelRegistry, registry
...
def test_llama_explainer_stub_mode(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from backend.ml.models.llama_explainer import LlamaExplainerAdapter
...
def test_gnn_fallback_embedding_is_deterministic() -> None:
    from backend.ml.models.gnn_base import _hash_embedding
