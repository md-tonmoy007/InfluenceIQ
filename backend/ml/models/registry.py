...
_REGISTRY: dict[str, str] = {
    # text classifiers
    "distilbert_spam": "backend.ml.models.distilbert_spam:DistilBertSpamAdapter",
    "deberta_spam": "backend.ml.models.deberta_spam:DebertaSpamAdapter",
    "toxic_bert": "backend.ml.models.toxic_bert:ToxicBertAdapter",
    "roberta_aigc": "backend.ml.models.roberta_aigc:RobertaAigcAdapter",
    ...
    "gcn": "backend.ml.models.gcn:GcnAdapter",
    "ggt": "backend.ml.models.ggt:GgtAdapter",
}
