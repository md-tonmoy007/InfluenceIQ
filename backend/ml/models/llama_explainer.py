...
`ML_LLM_ENDPOINT`. The endpoint must accept a JSON body of
...
`ML_LLM_ENDPOINT` is unset the adapter stays in a stub-only
...
_ENDPOINT = os.getenv("ML_LLM_ENDPOINT", "http://localhost:11434/api/generate")
