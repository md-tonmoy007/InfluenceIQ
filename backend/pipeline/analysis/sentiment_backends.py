...
3. The deterministic lexicon backend in
   :mod:`backend.pipeline.analysis.sentiment`.
...
from backend.pipeline.analysis.sentiment import score_text as lexicon_score
...
def analyze_sentiment_multi(
    ...
    *,
    ...
    :func:`backend.pipeline.analysis.sentiment.analyze_sentiment` so
