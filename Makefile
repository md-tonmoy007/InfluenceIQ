...
help:
	...
	@echo "  make cleanup      - Wipe all campaign/influencer data (preserves auth + profile)"
	@echo ""
...
cleanup:
	@echo "Wiping all campaign/influencer data (auth + profile preserved)..."
	$(COMPOSE) exec backend-core uv run --project backend python /workspace/scripts/cleanup_data.py --yes
