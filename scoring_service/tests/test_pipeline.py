...
from scoring_service.events import IdentityMerged, InfluencerFound, ScoreCalculated
from scoring_service.pipeline import run_role5_pipeline
from scoring_service.pipeline.orchestrator import trust_grade_to_confidence
from scoring_service.scoring.versioning import MODEL_VERSION, MODEL_VERSION_ALIAS
...
def test_pipeline_default_uses_v1_model_version() -> None:
    """With no UMGL_USE_*_V2 flags set, the orchestrator emits the v1
