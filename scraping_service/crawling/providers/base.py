...
from scraping_service.crawling.contracts import CrawlPage, platform_for_url
...
def fetch_platform_profile(url: str) -> dict[str, Any] | None:
    ...
    if platform == "youtube":
        from scraping_service.crawling.providers.youtube import fetch_youtube_profile

        providers[platform] = fetch_youtube_profile
    elif platform == "instagram":
        from scraping_service.crawling.providers.instagram import fetch_instagram_profile

        providers[platform] = fetch_instagram_profile
    elif platform == "tiktok":
        from scraping_service.crawling.providers.tiktok import fetch_tiktok_profile

        providers[platform] = fetch_tiktok_profile
    elif platform == "x":
        from scraping_service.crawling.providers.x import fetch_x_profile
