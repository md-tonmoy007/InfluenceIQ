...
This module intentionally sits at ``app.tasks._common`` (private) so
``from app.tasks import ...`` only re-exports the public task functions
...
from app.services.pipeline_state import update_pipeline_state
...
def publish_event(campaign_id: str, event_type: str, **payload: Any) -> dict:
    """Wrap :func:`app.services.event_log.emit_event` for the task bodies.
